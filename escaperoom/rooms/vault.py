    ...
    def solve(self):
        ...
        try:
            with self.open_file() as vault_file:
                ...
                # As I have three matching groups, will return a tuple
                # of 3 items
                ...
                for tup in tuple_result:
                    if len(tup) == 3:
                        ...
                        if value1 is None or value2 is None or value3 is None:
                            ...
                            # values are not a float: " + str(tup))
